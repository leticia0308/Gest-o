<?php $pagina = 'recepcionistas'; ?>

<div class="row botao-novo">
	<div class="col-md-12">
		<a id="btn-novo" data-toggle="modal" data-target="#modal"></a>
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Recepcionista</a>
	</div>
</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from recepcionistas where id = '$id_reg'");
					...
					echo 'Edição de Recepcionista';
				}else{
					$nome_botao = 'Salvar';
					echo 'Cadastro de Recepcionista';
				} ?>
			</h5>

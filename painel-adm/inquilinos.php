<?php $pagina = 'inquilinos'; ?>

<div class="row botao-novo">
	<div class="col-md-12">
		<a id="btn-novo" data-toggle="modal" data-target="#modal"></a>
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Inquilino</a>
	</div>
</div>
		...
		<div class="float-left">
			<form method="post">
				<select id="itens-pagina" onChange="submit();" class="form-control-sm" id="exampleFormControlSelect1" name="itens-pagina">
					...
					<option value="<?php echo @$item_paginado ?>"><?php echo @$item_paginado ?> Filtrar</option>

					<?php if(@$item_paginado != $opcao1){ ?> 
						<option value="<?php echo $opcao1 ?>"><?php echo $opcao1 ?> Filtrar</option>
					<?php } ?>

					<?php if(@$item_paginado != $opcao2){ ?> 
						<option value="<?php echo $opcao2 ?>"><?php echo $opcao2 ?> Filtrar</option>
					<?php } ?>

					<?php if(@$item_paginado != $opcao3){ ?> 
						<option value="<?php echo $opcao3 ?>"><?php echo $opcao3 ?> Filtrar</option>
					<?php } ?>
	...
	<div class="col-md-6 col-sm-12">
		<div class="float-right mr-4">
			<form id="frm" class="form-inline my-2 my-lg-0" method="post">
				...
				<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Nome ou telefone" aria-label="Search" name="txtbuscar" id="txtbuscar">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from inquilinos where id = '$id_reg'");
				...
				echo 'Edição de Inquilinos';
			}else{
				$nome_botao = 'Salvar';
				echo 'Cadastro de Inquilinos';
			} ?>
		</h5>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="idade" name="idade" placeholder="Insira a idade" required value="<?php echo @$idade ?>">
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							<label for="exampleFormControlInput1">Sexo</label>
							<input type="text" class="form-control" id="sexo" name="sexo" placeholder="Insira o genero" required value="<?php echo @$sexo ?>">
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="form-group">

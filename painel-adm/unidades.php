...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Nova Unidade</a>
	</div>
</div>
	...
	<div class="col-md-6 col-sm-12">
		<div class="float-right mr-4">
			<form id="frm" class="form-inline my-2 my-lg-0" method="post">
				...
				<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Buscar" aria-label="Search" name="txtbuscar" id="txtbuscar">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from unidades where id = '$id_reg'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['nome'];
					$identificacao = $dados[0]['identificacao'];
					$proprietario = $dados[0]['proprietario'];
					$condominio = $dados[0]['condominio'];
					$endereco = $dados[0]['endereco'];
					


				echo 'Edição de Unidades';
			}else{
				$nome_botao = 'Salvar';
				echo 'Cadastro de Unidades';
			} ?>
		</h5>
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="form-group">
						...
						<input type="hidden" id="proprietario"  name="proprietario" value="<?php echo @$proprietario ?>" required>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nome" name="nome" placeholder="Insira o nome" required value="<?php echo @$nome ?>">
						</div>
					</div>

					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							<label for="exampleFormControlInput1">Identificacao</label>
							<input type="text" class="form-control" id="identificacao" name="identificacao" placeholder="Insira a indenficacao" required value="<?php echo @$identificacao ?>">
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="proprietario" name="proprietario" placeholder="Insira o proprietario" required value="<?php echo @$proprietario ?>">
						</div>
					</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="condominio" name="condominio" placeholder="Insira o condominio" required value="<?php echo @$condominio ?>">
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="endereco" name="endereco" placeholder="Insira o endereco" value="<?php echo @$endereco ?>">
						</div>
					</div>
				</div>
